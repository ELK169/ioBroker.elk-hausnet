...
*/
 ...
 Objekte.forEach(function(element) 
    {
        A.log.debug("Objekt holen: "+ "System."+A.namespace+".Obj."+element.typ+"."+element.objname);

        A.getObject("System."+A.namespace+".Obj."+element.typ+"."+element.objname, function(err,obj) 
        {   
